...
const int CCPOPSIZE = 500;//300;//population size // Got optimal result with this size
...
int maxgen = 100000;//number of function evaluations
...
{
	public:
		void Execute(int samples, double h) 
		{
			VectorManipulation vectormanipulate;
			clock_t start = clock();
